...
angular.module('ToDoApp', [])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'JDHxOekOoBKQ9HpkqiOhopwi5gkM3uVlknQQv3TS';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'WdKItL0oUdW6xxWYzcYgXasywKNRuIIZi0YaBMk8';
    })
        ...
        $scope.refreshTasks = function () {
            ...
            $http.get('https://api.parse.com/1/classes/tasks' + '?where={"done" : false}')
                .success(function(responeData) {
                    ...
                    $scope.tasks = responeData.results;
                })
                .error(function(err) {
                    console.log(err);
            ...
            $scope.addTask = function(task) {
                ...
                $http.post('https://api.parse.com/1/classes/tasks', task)
                    .success(function(responeData) {
                        ...
                        task.objectId = responeData.objectId;
